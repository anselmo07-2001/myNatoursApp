...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var alertEl = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            // GET because we only want the cookie that overwrite the current cookie
...
console.log("Hello bobo"); // const locations = JSON.parse(document.getElementById("map").dataset.locations)
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    markerEl.className = "marker"; // adding the marker of each location coordinates

    new mapboxgl.Marker({
      element: markerEl,
      anchor: "bottom"
    }).setLngLat(location.coordinates) // input longitude first then lattitude
    .addTo(map); //adding a popup, this use together with the marker to provide info to the coordinate

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, " : ").concat(location.description, "</p>")).addTo(map); //extends the map boundary to include all the marker
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (result.data.status === "success") {
            (0, _alert.showAlert)("success", "".concat(type, " update successfully"));
            window.setTimeout(function () {
              location.assign("/me");
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _stripeJs.loadStripe)('pk_test_51NQm0yFlgDZqZzgN65vVtxf6rLocuRRvvBQxMOeH2WxJb2DojQXV5bug5FQryvh9ExZ1AbkLDDwGpbz2RSOTyNaU00zf7lzYyW');
...
var formPasswordSettings = document.querySelector(".form-user-password-settings");
...
if (formPasswordSettings) {
  formPasswordSettings.addEventListener("submit",
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
